/* -*- mode: C -*- Time-stamp: "2010-11-15 15:11:37 jemarch"
 *
 *       File:         rec-sex-destroy.c
 *       Date:         Mon Nov 15 15:06:48 2010
 *
 *       GNU recutils - rec_sex_destroy unit tests.
 *
 */
 ...
 */
START_TEST(rec_sex_destroy_nominal)
{
  rec_sex_t sex;
