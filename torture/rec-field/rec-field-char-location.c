/* -*- mode: C -*- Time-stamp: "2010-11-12 15:07:13 jemarch"
 *
 *       File:         rec-field-char-location.c
 *       Date:         Fri Nov 12 15:01:45 2010
 *
 *       GNU recutils - rec_field_char_location unit tests.
 *
 */
 ...
 */
START_TEST(rec_field_char_location_nominal)
{
  rec_field_t field;
