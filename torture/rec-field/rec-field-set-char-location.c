/* -*- mode: C -*- Time-stamp: "2010-11-12 15:09:31 jemarch"
 *
 *       File:         rec-field-set-char-location.c
 *       Date:         Fri Nov 12 15:01:45 2010
 *
 *       GNU recutils - rec_field_set_char-location unit tests.
 *
 */
 ...
 */
START_TEST(rec_field_set_char_location_nominal)
{
  rec_field_t field;
...
/* End of rec-field-set-char-location.c */
